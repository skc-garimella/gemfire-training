...
@"%GF_JAVA%" %JAVA_ARGS% -Dlog4j.configurationFile=/com/gemstone/gemfire/internal/logging/log4j/log4j2-cli.xml -classpath "%GEMFIRE_JARS%" com.gemstone.gemfire.internal.SystemAdmin %*
:done
@set scriptdir=
@set gf=
@set GEMFIRE_JARS=
